...
| `get_library_available_seats` | 도서관 전체 열람실의 live available 좌석 요약 | `mcp_session_id` | `LibraryAllAvailableSeatsResponse` |
| `get_room_available_seats` | 특정 열람실의 live available 좌석 목록 | `room_id`, `mcp_session_id` | `LibraryRoomAvailableSeatsResponse` |
