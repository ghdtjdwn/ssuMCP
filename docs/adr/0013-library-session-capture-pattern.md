...
- `docs/tasks/13-library-session-auth.md` (historical implementation specification)
- `docs/tasks/14-usaint-session-auth.md` — sibling Phase 3 specification, different shape
