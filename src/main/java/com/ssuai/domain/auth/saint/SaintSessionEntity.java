...
/** Encrypted, multi-replica source of truth for one SAINT credential namespace. */
@Entity
@Table(name = "saint_sessions")
class SaintSessionEntity {
    ...
    SaintSessionEntity(
        ...
        updateCredential(
                ...
                health, lastValidatedAt, lastSuccessfulCallAt, lastFailureAt, failureCode);
    }
